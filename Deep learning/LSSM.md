...
进一步的，所述双基于Mamba的时相交互式的编码模块包含：两个孪生的CNN残差模块、归一化层，线性嵌入层、SiLU激活函数、深度可分离卷积层、SS2D模块、以及两个非孪生的MLP模块。

所述CNN残差模块包括层归一层、线形层以及一个卷积层；

所述MLP模块包括层归一层以及一个扩大映射空间的线形层和一个还原映射空间的线性层；

进一步的，所述带有双阶导数边缘算子和频率自适应Mamba模块的差异模块包含：一阶导数边缘提取卷积层、二阶导数边缘提取卷积层、差异模块以及具有边缘聚焦的差异信息传入频率自适应Mamba模块。

进一步的，所述双阶导数边缘提取模块的包含：四个卷积核权重按Scharr算子初始化的卷积层；通过不同权重的Guass算法做差得到的3*3卷积核权重，得到符合Laplace算子约束的卷积层。

其中，以Guass算法初始化权重流程如下所示：

![](data:image/png;base64,)
...
进一步的，所述频率自适应Mamba模块包含：归一化层、线性嵌入层、SiLU激活函数、深度可分离卷积层、SS2D模块、 FADC频率自适应空洞卷积；

其中，FADC频率自适应空洞卷积如下所示:

![](data:image/png;base64,)
...
进一步的，所述目标物体重建模块包含：归一化层、线性嵌入层，然后分为两个分支、SiLU激活函数、深度可分离卷积层、SS2D模块、通道注意力模块、空间注意力模块；

所述通道注意力模块包括并行的平均池化和最大池化、MLP模块以及Sigmoid激活函数。

所述空间注意力模块包括并行的平均池化和最大池化、卷积核为7*7的卷积层以及Sigmoid激活函数。

进一步的，所述整个网络模型包含：线性嵌入模块、三层时相交互式编码模块，三层差异捕获模块、三层目标物体重建解码结构、动态融合模块、上采样层、下采样层以及分类器模块。

所述Stem模块包含两个卷积层、两个归一层以及一个GeLU激活函数。

所述动态融合模块包含第一卷积层和批归一层、SiLU激活函数、第二卷积层和批归一层以及tanh激活函数。

所述分类器模块包含一个归一层和两个卷积层。
...
71. 106900 1577 v17
72. 106901 1577 v17
73. 106920 1486 V17 test 0.7 300

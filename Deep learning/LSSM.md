...
9. 103502 1577 v8.1 再训练一次，我觉得是训练的问题
	1. 103578再跑一次，
	2. 把三个张量cat到一起可能造成了信息丢失,首先这是问题吗？再者如何解决这个问题呢？
10. 103503 1485 103255最好的一版中的DDB卷积弄到了逐通道卷积，看看得分有没有下来
11. 103514 1486 v8.2
接下来的工作：
...
1. 拿掉融合分支,也就是单独把主干拎出来
	1. 填上头
		1. 头的部分被放在ss2d当中，也就是要把ss2d拆开
		2. 也就是我现在的头部分全是共享参数，我要对比共享和独立哪个好
	2. BN和LN对比
	3. 修改跳接方式
		1. 直接cat
		2. 用senet
